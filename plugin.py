...
def pytest_addoption(parser):
    ...
    parser.addini(
        ...
        default=255,
        help="set the maximum filename length for static "
...
class HTMLReport:
    ...
    class TestResult:
        ...
        def create_asset(
            ...
            asset_path = os.path.join(
                os.path.dirname(self.logfile), "static", asset_file_name
            )

            os.makedirs(os.path.dirname(asset_path), exist_ok=True)

            relative_path = f"static/{asset_file_name}"
    ...
    def _save_report(self, report_content):
        dir_name = os.path.dirname(os.path.dirname(self.logfile))
        assets_dir = os.path.join(dir_name, "static")
